const devices = [
    {
        ...
        id: "0",
        image: "img/catalogo/i14promax.png",
        colorOptions: ["white", "black", "bisque", "darkslateblue"],
        prices: [1000000, 1249990, 1449990, 1599990],
        storageOptions: [128,256, 512, 1024]
    },
    {
        name: "iPhone 14 Pro",
        id: "1",
        image: "img/catalogo/i14pro.png",
        colorOptions: ["white", "black", "bisque", "darkslateblue"],
        prices: [999990, 1199990, 1200000, 1300000],
        storageOptions: [128, 256, 512, 1024]
    },
    {
        name: "iPhone 14 Plus",
        id: "2",
        image: "img/catalogo/i14plus.png",
        colorOptions: ["white", "black", "skyblue", "darkred", "darkslateblue", "yellow"],
    ...
    },
    {
        name: "iPhone 14",
        id: "3",
        image: "img/catalogo/i14.png",
        colorOptions: ["white", "black", "skyblue", "darkred", "darkslateblue", "pink"],
    ...
    },
    {
        ...
        id: "4",
        image: "img/catalogo/i13promax.png",
        colorOptions: ["white", "black", "skyblue", "darkgreen"],
        prices: [699990, 799990, 899990, 950000],
        storageOptions: [128, 256, 512, 1024]
    },
    {
        name: "iPhone 13 Pro",
        id: "5",
        image: "img/catalogo/i13pro.png",
        colorOptions: ["white", "black", "skyblue", "darkgreen"],
        prices: [399990, 479990, 500000, 600000],
        storageOptions: [128, 256, 512, 1024]
    },
    {
        name: "iPhone 13",
        id: "6",
        image: "img/catalogo/i13.png",
        colorOptions: ["white", "black", "darkred", "darkcyan", "pink", "darkgreen"],
        prices: [599990, 659990, 800000],
        storageOptions: [128, 256, 512]
    },
    {
        name: "iPhone 13 Mini",
        id: "7",
        image: "img/catalogo/i13mini.png",
        colorOptions: ["white", "black", "darkred", "darkcyan", "pink", "darkgreen"],
